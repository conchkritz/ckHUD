...
Scheme
{
	Colors
	{
		...
		"G_TitleBg"					"96 83 73 255" // Title bg color
		"G_TitleText"				"242 242 242 255" // Title text color
		"G_Highlight"				"96 83 73 255" // Highlight color
		"G_ConsoleBg"				"56 50 44 255" // Console bg color
		"G_ListBg"					"36 33 29 255" // List bg color
		"G_Border"					"0 0 0 51" // Border color
		"G_Text"					"242 242 242 255" // Text color
		"G_HighlightText"			"242 242 242 255" // Highlight text color
		"G_SelectedText"			"242 242 242 255" // Selected text color
		"G_DisabledText"			"220 206 199 150" // Disabled text color
		"G_ButtonBg"				"96 83 73 255" // Button bg color
		"G_ButtonText"				"242 242 242 255" // Button text color
		"G_ButtonHoverBg"			"161 148 132 255" // Button hover bg color
	    ...
	    "QuickListBGSelected"       "96 83 73 255" // Highlight color
