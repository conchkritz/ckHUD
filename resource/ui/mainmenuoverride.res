...
//		"bgcolor_override"	"0 0 0 240"
	...
	"CycleRankTypeButton"
	{
		...
		"image_drawcolor"	"kritzwhite"
		"image_armedcolor"	"kritzdullwhite"
		"defaultFgColor_override" "kritzwhite"
		"armedFgColor_override"   "kritzdullwhite"
	...
	"Notifications_ShowButtonPanel"
	{
		...
		"image_armedcolor"	"colordullwhite"
		...
		"Notifications_CountLabel" // fix later
		{
			"ControlName"	"CExLabel"
		...
		"Notifications_ShowButtonPanel_SB"
		{
			...
			"border_default" "box"
			"border_armed" "box"
			"defaultBgColor_override" "colordarkgray"
			"armedBgColor_override" "colorblack"
			
			"image_drawcolor"	"255 255 0 255"
			"image_armedcolor"	"200 200 20 255"
	...
	"ReloadHud" // main anchor
	{
		...
		"SubButton"
		{
			...
			"border" "noborder"
			"image_drawcolor"	"colorwhite"
			"image_armedcolor"	"colordarkwhite"
	...
	"ReplaysTop"
	{
		...
		"MOTD_ShowButtonPanel_SB"
		{
			...
			"SubImage"
			{
				...
				"visible"		"1"
				"enabled"		"1"
				"image"			"replay/thumbnails/buttons/reel"
				"scaleImage"	"1"
			}
		}
	}
	"MOTD_Panel"
	{
		...
		"MOTD_TextScroller"
		{
			...
			"tall"			"110"
			"PaintBackgroundType"	"2"
			"fgcolor_override"	"colordarkgray"
		...
		"MOTD_PrevButton"
		{
			...
			"image_drawcolor"	"colordullwhite"
			"image_armedcolor"	"colorblack"
			"SubImage"
			{
				"ControlName"	"ImagePanel"
				"fieldName"		"SubImage"
	...
	"Notifications_Panel" // needs polishing
	{
		"ControlName"	"EditablePanel"
		...
		"Notifications_CloseButton"
		{
			...
			"defaultFgColor_override" "colordarkgray"
			"armedFgColor_override" "colordullwhite"
			"depressedFgColor_override" "colordarkgray"
	...
	"FriendsContainer"
	{
		...
		"TitleLabel"
		{
			...
			"defaultFgColor_override"	"colorwhite"
			"armedFgColor_override"						"colordullwhite"
			"sound_depressed" "ui\poot.wav" // pootis
...
//			"tall"			"120"
	...
	"VersionLabel"
	{
		...
		"command"		"engine con_enable 1;showconsole;snd_restart;clear;play ui/sussus_amogus.wav;
		echo -----------||||||||||...;
		echo --------.|||--------|||..;
		echo --------||^---------...^|||.;
		echo -------|||----.||||||||||||.;
	...
	"DemoUiButton"
	{
		...
		"pin_to_sibling" "ToogleDevConsole"
		"defaultFgColor_override" 	"colorwhite"
		"armedFgColor_override"		"colordullwhite"
	}
